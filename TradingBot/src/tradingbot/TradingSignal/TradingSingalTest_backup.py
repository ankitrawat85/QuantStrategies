from tradingbot.TradingSignal.SignalGeneration.TechnicalIndicators.TrendLine.trendline_api_backup import  run_methods
...
def signal_generation(date,token,tradingsymbol,snapshot = False):
  ...
  results = run_methods(
    ...
    main_stream_path="/Users/ankit/Desktop/GitHub/AlgoTrading/QuantStrategies/TradingBot/src/tradingbot/TradingSignal/SignalGeneration/TechnicalIndicators/TrendLine/main_trendline_stream_backup.py",
    min_confidence=0.00,
    parallel=False,              # default
    max_workers=None,           # defaults to len(methods)
    write_plots=True,           # default (no plots generated)
