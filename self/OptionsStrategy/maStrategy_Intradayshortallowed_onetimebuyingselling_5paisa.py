...
from  self.OptionsStrategy.OptonsTechnicalAnalysis_main import technicalIndicators
...
if __name__ == "__main__":
    ...
    output_ = output_[["Datetime","Open","High","Low","Stock_BUY_Sell","Position","Realised_PNL","MTM","AvgPrc","trading_signal","liquidatePosition"]].set_index("Datetime")
    ...
    output_ = output_.merge(df_[["VPT","StochasticOscillator_signal","BBMsignal","macdsignal","BBP_Signal_price"]],how='left', left_index=True, right_index=True)
    print(output_)
