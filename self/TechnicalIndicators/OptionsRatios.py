...
path = str(path) + "/commonFunctions/code_dir/NSEStock.db"
...
df = pd.read_sql_query("select * from OptionChainRatios where PE_expiryDate = '06-Jan-2022' and strikePrice >= 17400  and strikePrice <= 17800;",con)
df_ = df[df["strikePrice"] == 18000][["Date", "PCR_OI" ,"PCR_vol"]]
...
print("Strike Price : -  {}".format(18000))
