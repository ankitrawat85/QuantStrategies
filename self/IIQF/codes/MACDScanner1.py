...
#            return
        ...
        # strategy dependent
        short_period, long_period, long_entry, short_entry = settings.GetSignalPara_MACD()
        ...
        # user dependent
        dfstrategystatus = ss.GetStrategyStatus('/COMPANIES/IIQF/COURSES/CPAT/2022-Oct/MACDStrategyState.csv')
            ...
            for stocknum in range(len(tradescanlist)):
                ...
                if (is_order_executing == False):
                    ...
                    if (pos == 0):
                        ...
                        current_signal = sg.generate_signal_MACD_v1(stockname, spotltp, short_period, long_period, long_entry, short_entry, historical_data_path)
...
#                            pass
            ...
            myutils.write_dataframe('/COMPANIES/IIQF/COURSES/CPAT/2022-Oct/MACDStrategyState.csv', dfstrategystatus)
