...
#            return
        ...
        while (current_time < stoptime):
            ...
            for stocknum in range(len(tradescanlist)):
                # read the emegency stop file, if 1 stop algo
...
#                        t1= time.process_time_ns()
                        ...
                        current_signal = sg.generate_signal_RSI_v1(stockname, spotltp, windowperiod, long_entry, short_entry, historical_data_path)
                        
#                        print((time.process_time_ns() - t1)/ 1000000, 'ms')
#                        print((time.perf_counter_ns() - t1)/ 1000000, 'ms')
...
#                print((time.perf_counter_ns() - t1)/ 1000000, 'ms')
            ...
            myutils.write_dataframe('/COMPANIES/IIQF/COURSES/CPAT/2022-Oct/RSIStrategyState.csv', dfstrategystatus)
